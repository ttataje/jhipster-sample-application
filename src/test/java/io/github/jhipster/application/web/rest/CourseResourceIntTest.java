...
import io.github.jhipster.application.domain.enumeration.CourseLevel;
/**
...
public class CourseResourceIntTest {
    ...
    private static final CourseLevel DEFAULT_COURSE_LEVEL = CourseLevel.BASICO;
    private static final CourseLevel UPDATED_COURSE_LEVEL = CourseLevel.AVANZADO;
